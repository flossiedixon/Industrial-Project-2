...
def simulation_test(model_params, strength_params, obstacle_params, obs_method, attractor_pos, wind_params, goal: float, seed = 10 ):
    ...
    for iT in range(Nt):
        ...
        if len(x) > 0:
            ...
            x, y, vx, vy, theta = sim.step(x, y, vx, vy, theta, dt, L, A, 
                lam_c, lam_a, lam_m, lam_att, eta, v0, R, obstacle_params, obs_method, attractor_pos, wind_params)
